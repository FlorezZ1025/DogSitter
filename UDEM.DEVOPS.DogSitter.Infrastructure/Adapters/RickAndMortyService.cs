...
{
    public class RickAndMortyService(HttpClient httpClient, ILogger<RickAndMortyService> logger) : IRickAndMortyService
    {
        ...
        {
            logger.LogInformation("[ADAPTER] Sending request to Rick and Morty API...");
            ...
            logger.LogInformation("[ADAPTER] Response received successfully.");
